...
class WecomApp(models.Model):
    ...
    def send_message(self, title, msg_type='textcard', url=None, description='', image_url=None,
        ...
        """
        self.ensure_one()
        message = self.env['wecom.app.message'].sudo().create({
            'app_id': self.id,
            'name': title,
            'msg_type': msg_type,
            'url': url or False,
    ...
    def _send_message(self, title, url=None, msg_type='textcard', description='', image_url=None,
        ...
        if msg_type == 'mpnews':
            ...
            return client.message.send_mp_articles(self.wecom_agent_id, user_ids, [{
        ...
        if msg_type == 'news':
            ...
            return client.message.send_articles(self.wecom_agent_id, user_ids, [{
                'title': title,
